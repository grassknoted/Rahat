...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    static private List<WiFiChatMessage> Messages;
    static private ArrayAdapter<WiFiChatMessage> adapter;
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.send) {
            ...
            WiFiChatMessage chatMessage = new WiFiChatMessage(text.toString(), true, "", time);
             ...
             */
            AsyncTask<WiFiChatMessage,Void,Void> sendMessage = new AsyncTask<WiFiChatMessage, Void, Void>() {

                @Override
                protected Void doInBackground(WiFiChatMessage... chatMessage)
                {
     ...
     * 3. Create a new WiFiChatMessage msg = new WiFiChatMessage(text.toString(), false, sender, time_stamp);
    ...
    */
    public static void receive(String data){
        WiFiChatMessage chatMessage = new WiFiChatMessage(data);
