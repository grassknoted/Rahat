...
public class ChatMessageAdapter extends ArrayAdapter<WiFiChatMessage> {

    private List<WiFiChatMessage> chatmessages;
    private Activity act;

    public ChatMessageAdapter(Activity context, int res, List<WiFiChatMessage> messagesList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        WiFiChatMessage chatMessage = getItem(position);
